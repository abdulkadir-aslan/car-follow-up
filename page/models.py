...
class Fuell(models.Model):
    ...
    kilometer = models.FloatField(verbose_name="Kilometre",max_length=20,null=False,blank=False)
    average = models.FloatField(verbose_name="Ortalama Yakıt",null=False,blank=False)
    liter = models.FloatField(verbose_name="Litre",blank=False,null=False)
